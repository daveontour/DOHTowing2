 ...
 *         &lt;element name="airlineIdentifierType" type="{http://schemas.datacontract.org/2004/07/WorkBridge.Modules.AMS.AMSIntegrationAPI.Mod.Intf.DataTypes}CodeContext" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetSlotRequestsForAirline")
public class GetSlotRequestsForAirline {
    ...
    @XmlElementRef(name = "airlineCode", namespace = "http://www.sita.aero/ams6-xml-api-webservice", type = JAXBElement.class, required = false)
    protected JAXBElement<String> airlineCode;
    @XmlSchemaType(name = "string")
    protected CodeContext airlineIdentifierType;
    ...
    /**
     * Gets the value of the airlineIdentifierType property.
     * 
     * @return
     *     possible object is
     *     {@link CodeContext }
     *     
     */
    public CodeContext getAirlineIdentifierType() {
        return airlineIdentifierType;
    }

    /**
     * Sets the value of the airlineIdentifierType property.
     * 
     * @param value
     *     allowed object is
     *     {@link CodeContext }
     *     
     */
    public void setAirlineIdentifierType(CodeContext value) {
        this.airlineIdentifierType = value;
    }
